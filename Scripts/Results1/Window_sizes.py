...
def window_sizes(path_init):
    ...
    ha_2 = [['left','','','','center','','','','center','','','','right'],
            ['left','','','','center','','','','center','','','','right']]
    ha_3 = [['left','','','','center','','','','center','','','','right'],
            ['left','','','','center','','','','center','','','','right']]
    ha_all = [ha_1,ha_2,ha_3] 
    
    xytext_1 = [[12,0,0,0,12,0,0,0,12,0,0,0,12],
                [-18,0,0,0,-18,0,0,0,-23,0,0,0,-18]]
    xytext_2 = [[15,0,0,0,12,0,0,0,12,0,0,0,-18],
                [-18,0,0,0,-18,0,0,0,-18,0,0,0,-18]]
    xytext_3 = [[-18,0,0,0,12,0,0,0,-18,0,0,0,-18],
    ...
    plt.ylim(-1,1)
    fig.tight_layout()
    plt.savefig(path_init + '\\Images\\Results1\\Window Sizes\\window_sizes_lc.png', format='png', dpi=300, bbox_inches='tight')
    plt.show()
    plt.close(fig=fig)
